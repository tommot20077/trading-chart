...
class TestConnectionEvent:
    ...
    def test_connection_event_with_additional_data(self):
        ...
        additional_data = {
            "retry_count": 3,
            "last_error": "timeout",
            "endpoint": "wss://api.binance.com/ws"
        }
    ...
    def test_connection_event_missing_required_fields(self):
        """
        Test ConnectionEvent creation with missing required fields.
    ...
    def test_connection_event_symbol_validation_inheritance(self):
        ...
        event_no_symbol = ConnectionEvent(
            status=ConnectionStatus.CONNECTED,
            source="test_client"
        )
