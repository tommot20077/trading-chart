...
from core.models.event.subscription import Subscription, EventHandler, AsyncEventHandler
...
class TestSubscription:
    ...
    def test_subscription_with_mock_handlers(self):
        ...
        # Test with sync mock
        sync_mock = Mock()
        subscription_sync = Subscription(
    ...
    def test_subscription_handler_type_detection(self):
        ...
        async_lambda = lambda event: asyncio.sleep(0)
    ...
    def test_subscription_boundary_values(self):
        ...
        subscription2 = Subscription(
            subscription_id="sub_long_symbol",
            event_type=EventType.TRADE,
            handler=handler,
            filter_symbol=long_symbol
        )
    ...
    def test_subscription_matches_with_none_symbol_event(self):
        ...
        unfiltered_subscription = Subscription(
            subscription_id="unfiltered",
            event_type=EventType.SYSTEM,
            handler=handler
        )
        
        # Event with None symbol
        none_symbol_event = BaseEvent(
            event_type=EventType.SYSTEM,
            source="test",
            symbol=None,
            data={"test": "data"}
