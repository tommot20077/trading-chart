...
class TestEventStorageStats:
    ...
    def test_event_storage_stats_creation_with_all_parameters(self):
        ...
        # Arrange
        total_events = 10000
        events_by_type = {"trade": 5000, "kline": 3000, "error": 100, "connection": 50, "system": 1850}
    ...
    def test_event_storage_stats_events_by_type_structure(self):
        ...
        standard_events = {"trade": 1000, "kline": 500, "order": 200, "connection": 10, "error": 5, "system": 50}
        ...
        custom_events = {"custom_event_type_1": 100, "custom_event_type_2": 200, "special-event": 50}
    ...
    def test_event_storage_stats_time_range_validation(self):
        ...
        # Act
        stats = EventStorageStats(oldest_event_time=oldest_time, newest_event_time=newest_time)
    ...
    def test_event_storage_stats_same_oldest_newest_time(self):
        ...
        # Act
        stats = EventStorageStats(oldest_event_time=same_time, newest_event_time=same_time)
    ...
    def test_event_storage_stats_large_numbers(self):
        ...
        # Act
        stats = EventStorageStats(
            total_events=large_total, storage_size_bytes=large_storage, avg_event_size_bytes=large_avg
        )
    ...
    def test_event_storage_stats_zero_values(self):
        ...
        """
        # Act
        stats = EventStorageStats(total_events=0, storage_size_bytes=0, avg_event_size_bytes=0.0)
    ...
    def test_event_storage_stats_inconsistent_data(self):
        ...
        stats = EventStorageStats(total_events=total_events, events_by_type=events_by_type)
    ...
    def test_event_storage_stats_negative_values(self):
        ...
        stats = EventStorageStats(total_events=-100, storage_size_bytes=-1024, avg_event_size_bytes=-10.5)
