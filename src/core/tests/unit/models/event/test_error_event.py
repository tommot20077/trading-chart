...
class TestErrorEvent:
    ...
    def test_error_event_str_representation(self):
        ...
        # Act
        event = ErrorEvent(
            error="String representation test",
            source="test_client"
        )
    ...
    def test_error_event_symbol_validation_inheritance(self):
        ...
        event_no_symbol = ErrorEvent(
            error="No symbol test",
            source="test_client"
        )
    ...
    def test_error_event_different_priority_levels(self):
        ...
        for priority in priorities:
            event = ErrorEvent(
                error=f"Error with {priority} priority",
                source="test_client",
                priority=priority
            )
