...
class TestConnectionStatus:
    ...
    def test_connection_status_state_transitions(self):
        ...
        valid_transitions = {
            ...
            ConnectionStatus.CONNECTED: [ConnectionStatus.DISCONNECTED, ConnectionStatus.ERROR, ConnectionStatus.RECONNECTING],
            ConnectionStatus.RECONNECTING: [ConnectionStatus.CONNECTED, ConnectionStatus.ERROR, ConnectionStatus.DISCONNECTED],
